...
const ACTIONS = [
  ...
  { id: 'prepare',     label: 'เตรียมของ / แก้ไขการเตรียมของ (ทุกหน้า)', onlyFor: ['assembly'] },
  { id: 'assemble',    label: 'ประกอบ/ทำ',   onlyFor: ['assembly'] },
  { id: 'qc',          label: 'QC / ตรวจงาน', onlyFor: ['assembly'] },
  { id: 'queue',       label: 'เห็นคิวงาน',    onlyFor: ['assembly'] },
  { id: 'history',     label: 'เห็นประวัติงาน', onlyFor: ['assembly'] },
  { id: 'stats',       label: 'เห็นสถิติช่าง',  onlyFor: ['assembly'] },
